...
| Skill                                                     | Use it for                                                                                                                                                                                                                                                            |
| --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`outreach-strategist/`](./outreach/outreach-strategist/) | Coordinating outbound campaigns end to end: campaign-as-data folders, per-contact research dossiers, stream routing, graduated autonomy tiers, and Discord reporting — with the four pipeline subskills (command, cadence, copywriter, copy QA) bundled as references |
...
| Plan or run an outbound campaign        | `outreach/outreach-strategist/`                                                                   |
