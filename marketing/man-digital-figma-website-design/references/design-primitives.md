...
| **✨ Decorative Elements (40000579:2358)**                     | Sole master library for every website decoration component. Landing-page and Design System consumers must use instances resolving here; never keep a decoration master, detached copy or redraw elsewhere. Blue-section connective arcs: `40000864:2416`. Rule: max ONE motif per section, behind content, flat only.                                                                                                                                                                                                 |
...
- **Decorative:** dot-grid pattern on blue, orange/blue circles and the connective-arcs
  component (`40000864:2416`) as accents — sparingly. Always insert an instance whose
  main component lives on `✨ Decorative Elements (40000579:2358)`. Never clone or detach
  its vectors into a page or the Design System. Use at most one composite motif per
  section, place it behind content, and keep it clear of text.
