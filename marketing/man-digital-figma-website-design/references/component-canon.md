...
| Decorative motifs | Sole master page `40000579:2358`; blue-section connective arcs `40000864:2416` | Insert an instance whose main component resolves to `✨ Decorative Elements`. Never create, detach, redraw or maintain a decorative master on a landing-page or Design System page. Update the master here so consumers inherit the change. Use at most one composite motif per section, behind content, distributed through long pages, flat and never over text. |
