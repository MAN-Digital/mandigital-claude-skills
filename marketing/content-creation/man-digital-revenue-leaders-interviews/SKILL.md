...
9. Run `python3 scripts/validate_interview.py <interview-asset-directory>` and the CMS source validator when source files changed. When ingestion or validation changes, also run `python3 scripts/test_ingest_interview_source.py` and `python3 scripts/test_validate_interview.py`.
