...
version: 1.4.0
description: >
  Animation for React, CSS, and HubSpot modules, plus deterministic frame-by-frame export of any
  HTML animation to video (MP4/ProRes) at 25 or 50 fps for video editing. Use this skill whenever
  the user mentions animations, transitions, hover effects, page or route transitions, modals,
  reveals, staggered lists, easing, or motion of any kind in a web UI — even if they don't say
  "animate". Also use it whenever they want to turn an HTML page, Pencil export, or component into
  a video, MP4, MOV, ProRes file, PNG sequence, or animated asset for a timeline, or mention
  rendering, frame-by-frame capture, Playwright screenshots, or ffmpeg encoding of a web page.
  Includes the fit pass that reflows a blog-shaped design into the 16:9 frame before any
...
compatibility: >
  Web track needs no dependencies. Render track needs Python 3.9+, playwright (plus
