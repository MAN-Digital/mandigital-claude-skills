...
when_to_use: After a spine cut is locked and executed, on the conformed word-level JSON of the cut sequence. Never on a raw session export (the spine cut handles dead air between takes).
