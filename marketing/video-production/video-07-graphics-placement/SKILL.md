...
when_to_use: Existing assets plus a locked cut. Any request about graphic placement, cue timing, or whether a visual is supported by what is said. Also requests to propose or prioritize NEW graphics against a locked cut ("fill the script", "which are worth building").
