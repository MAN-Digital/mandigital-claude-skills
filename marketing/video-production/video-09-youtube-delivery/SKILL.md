...
when_to_use: ONLY after Diogo says the video is approved and names/points at the SRT. Never auto-run from the pipeline; never mid-edit (approval implies the cut is final). Works on pipeline artifacts (preferred) or any bare SRT.
