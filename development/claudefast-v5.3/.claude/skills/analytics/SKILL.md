...
- **[datafast-docs.md](./datafast-docs.md)** - Complete DataFast official documentation: script config, proxy setup, revenue attribution, custom goals, API reference, UTM tracking, conversion funnels, Google Search Console integration, and platform-specific install guides
