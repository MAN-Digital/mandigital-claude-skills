...
- **The "sameness" trap**: Claude defaults to Inter/Geist + purple accent + white bg + 8px radius on everything. If your output looks like it could be any SaaS landing page, you haven't committed to a direction. Check aesthetic-directions.md and use the exact Quick Reference values.
