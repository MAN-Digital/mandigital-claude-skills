---
name: android
description: Complete Android development skill combining Material Design 3 guidelines (50+ rules) with 6 official Google development skills from android/skills -- AGP 9 upgrade, XML-to-Compose migration, Navigation 3 (20 recipes), R8 keep rule analyzer, Play Billing Library upgrade, and edge-to-edge Compose support. Use when building, reviewing, or migrating Android apps.
license: MIT
metadata:
  author: platform-design-skills, Google LLC
  version: "2.0.0"
---

Complete Android development skill combining Material Design 3 design guidelines with official Google development best practices.

## Android Development Skills (from [android/skills](https://github.com/android/skills))

6 official skills for Android migrations, performance, and modern patterns:

| Category        | Skill                                                                           | Description                                                   |
| --------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| Build           | [AGP 9 Upgrade](build/agp-9-upgrade/SKILL.md)                                   | Migrate to Android Gradle Plugin 9, new DSL, built-in Kotlin  |
| Jetpack Compose | [XML to Compose](jetpack-compose/migrate-xml-views-to-jetpack-compose/SKILL.md) | 10-step structured XML View to Compose migration workflow     |
| Navigation      | [Navigation 3](navigation/navigation-3/SKILL.md)                                | Install, migrate, and implement Nav3 with 20 code recipes     |
| Performance     | [R8 Analyzer](performance/r8-analyzer/SKILL.md)                                 | Analyze keep rules for redundancy and app size optimization   |
| Play            | [Play Billing Upgrade](play/play-billing-library-version-upgrade/SKILL.md)      | Migrate to latest Play Billing Library (direct/stepped paths) |
| System          | [Edge-to-Edge](system/edge-to-edge/SKILL.md)                                    | Adaptive edge-to-edge with insets, IME, system bars           |

Each sub-skill has its own `SKILL.md` and `references/` folder. Read the relevant SKILL.md for detailed instructions.

### Upstream Sync

```bash
# Check for new/changed files vs android/skills repo
gh api "repos/android/skills/git/trees/main?recursive=1" \
  --jq '.tree[] | select(.type == "blob") | .path' | sort > /tmp/upstream.txt

# Pull a specific file
gh api -H "Accept: application/vnd.github.raw+json" \
  "repos/android/skills/contents/<path>"
```

| Date       | Skills | Files | Notes                          |
| ---------- | ------ | ----- | ------------------------------ |
| 2026-04-16 | 6      | 50    | Initial adaptation from source |
